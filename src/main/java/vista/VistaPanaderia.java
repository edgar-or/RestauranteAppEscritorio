 ...
 * @author estud
 */
public class VistaPanaderia extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VistaPanaderia.class.getName());

    /**
     * Creates new form vistaPrincipal
     */
    public VistaPanaderia() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new VistaPanaderia().setVisible(true));
    }
